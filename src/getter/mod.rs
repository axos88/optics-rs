...
pub trait Getter<S, A>: HasPartialGetter<S, A, GetterError = Infallible> + HasGetter<S, A> {}

impl<S, A, G: HasPartialGetter<S, A, GetterError = Infallible> + HasGetter<S, A>> Getter<S, A>
    for G
{
}
